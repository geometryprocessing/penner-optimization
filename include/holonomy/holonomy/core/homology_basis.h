...
/**
 * @brief Methods to generate basis dual loops for a mesh. A closed genus g surface has
 * 2g basis loops.
 * 
 * For meshes with boundary, this generates the basis loops that do not bound holes.
 * Basis loops corresponding holes are generally irrelevant in the seamless context, 
 * but can be generated by the Boundary Basis methods.
 * 
 */
