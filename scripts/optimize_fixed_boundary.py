...
def run_one(args, fname):
    ...
    boundary_paths, boundary_map = holonomy.build_boundary_paths(m)
    ...
    dirichlet_metric = holonomy.DirichletPennerConeMetric(
        marked_metric, 
        boundary_paths,
    ...
    optimized_metric = holonomy.optimize_metric_angles(dirichlet_metric, alg_params)
