...
def colormap_histogram_one(args, fname):
    ...
    # Get logger
    log_path = os.path.join(args['output_dir'], m + "_output", m+'_colormap_histogram.log')
    ...
    os.makedirs(os.path.join(args['output_dir'], 'colormap_histograms'), exist_ok=True)
    ...
    analysis.generate_histogram(X, label, binrange, output_path, ylim=args['ylim'],)
...
if __name__ == "__main__":
    ...
    parser = script_util.generate_parser("Generate colormap histograms for mesh")
