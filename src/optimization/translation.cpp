                                              ...
                                              const VectorX& halfedge_shear_change)
{
  MatrixX lagrangian_matrix;
  VectorX right_hand_side;
  generate_translation_lagrangian_system(m, halfedge_shear_change, lagrangian_matrix, right_hand_side);

  return std::make_tuple(lagrangian_matrix, right_hand_side);
}
...
compute_as_symmetric_as_possible_translations_pybind(
  ...
  VectorX he_translations;
  compute_as_symmetric_as_possible_translations(m, he_metric_coords, he_metric_target, he_translations);
  return he_translations;
}
#endif
