...
namespace CurvatureMetric
{
                  ...
                  bool need_jacobian)
  {
    ...
    if (need_jacobian)
    {
      ...
      for (int h = 0; h < num_halfedges; ++h)
      {
        tripletList.push_back(T(target_cone_metric.f[h], target_cone_metric.he2e[h], he2J1he[h]));
      }
                           ...
                           bool need_jacobian)
  {
    ...
    if (need_jacobian)
    {
      ...
      for (int h = 0; h < num_halfedges; ++h)
      {
        ...
        tripletList.push_back(T(target_cone_metric.f[h], target_cone_metric.he2e[h], J_f2J2sq_fe));
      }
                           ...
                           bool need_jacobian)
  {
    ...
    VectorX f2J1;
    MatrixX J_f2J1;
    first_invariant(target_cone_metric,
                    metric_coords,
                    f2J1,
                    J_f2J1,
                    need_jacobian);
    ...
    VectorX f2J2sq;
    MatrixX J_f2J2sq;
    second_invariant_squared(target_cone_metric,
                             metric_coords,
                             f2J2sq,
                             J_f2J2sq,
                             need_jacobian);
  ...
  MatrixX surface_hencky_strain_energy(const DifferentiableConeMetric &target_cone_metric)
  {
    ...
    for (int f = 0; f < num_faces; ++f)
    {
      ...
      std::array<Scalar, 3> lengths = {target_cone_metric.l[hjk], target_cone_metric.l[hki], target_cone_metric.l[hij]};
