...
/// Compute the implicit optimization convergence ratio of a metric.
///
/// Note that this method computes the projected descent direction from scratch and
/// is thus slow and redundant for use in the optimization. It is meant only for
...
/// Given a metric, compute the energy values for optimization along the projected descent
/// direction at given (potentially negative) step sizes before and after the projection
/// to the constraint.
///
/// @param[in] m: input mesh
/// @param[in] reduced_metric_coords: metric coordinates
